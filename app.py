...
def analysisPage():
	...
	@@ -55,33 +55,35 @@ def fetchDocuments(tickerCIKs, company):
        """
	...
	@@ -92,59 +94,60 @@ def fetchDocuments(tickerCIKs, company):
            counter += 1
	...
	@@ -193,40 +194,43 @@ def computeSim(dataset):
            l += 1
